...
export function useSessionManager(
  ...
  useEffect(() => {
    if (
      chineseLearningContent["HSK3"] &&
      chineseLearningContent["HSK3"].topics["Restaurant"]
    ) {
        ...
        tools: [
          {
            ...
            name: "trackProgress",
            description:
              "Tracks progress of the mission by marking a phrase as completed",
            parameters: {
              type: "object",
              properties: {
                phrase: {
                  type: "string",
                  description:
                    "The Chinese phrase the student correctly repeated",
                },
              },
              required: ["phrase"],
            },
  ...
  function generateBeginnerPrompt() {
    ...
    const phrases = [
      {
        ...
        pinyin: "zhōumò",
        english: "weekend",
        explanation: "A noun referring to Saturday and Sunday.",
      },
      {
        chinese: "打算",
        pinyin: "dǎsuàn",
        ...
        explanation:
          "Can be used as a noun ('plan') or verb ('intend to do something').",
      },
    ...
    const conversation = [
      {
        ...
        explanation:
          "打算 (dǎsuàn) means 'plan' or 'intend to do something.' This question asks about someone's weekend plans.",
      },
      {
        ...
        english:
          "I’ve already planned—I'll invite you to eat, watch a movie, and drink coffee.",
        explanation:
          "早就 (zǎo jiù) means 'a long time ago.' 想好 (xiǎng hǎo) means 'decided.' The sentence lists activities using commas.",
      },
      {
        chinese: "请我？",
        pinyin: "Qǐng wǒ?",
        english: "Invite me?",
        explanation:
          "请 (qǐng) means 'invite.' The short sentence expresses surprise at the invitation.",
      },
      {
        chinese: "是啊，我已经找好饭馆了，电影票也买好了。",
        pinyin:
          "Shì a, wǒ yǐjīng zhǎo hǎo fànguǎn le, diànyǐng piào yě mǎi hǎo le.",
        english:
          "Yes! I’ve already found a restaurant, and I bought the movie tickets too.",
        explanation:
          "找好 (zhǎo hǎo) means 'successfully found.' 买好 (mǎi hǎo) means 'successfully bought.' The structure emphasizes completed actions.",
      },
      {
        ...
        explanation:
          "还没 (hái méi) means 'haven't yet.' 想好 (xiǎng hǎo) means 'decided.' 要不要 (yào bú yào) presents a yes/no decision.",
      },
    ];
    ...
    phrases.forEach((phrase, index) => {
      prompt += `${index + 1}. ${phrase.chinese} (${phrase.pinyin}) - ${
        phrase.english
      }\n   - ${phrase.explanation}\n`;
    });
    ...
    conversation.forEach((line, index) => {
      prompt += `${index + 1}. ${line.chinese} (${line.pinyin}) - ${
        line.english
      }\n   - ${line.explanation}\n`;
    });
